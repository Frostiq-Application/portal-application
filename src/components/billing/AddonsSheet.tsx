...
import { Infinity as InfinityIcon, Loader2, Minus, PackagePlus, Plus, RotateCcw, Trash2 } from "@/components/ui/icons";
import {
...
export function AddonsSheet({
  ...
  const [payDetail, setPayDetail] = useState<{ label: string; amount: string } | null>(
    null,
  );
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="flex w-full flex-col gap-0 p-0 sm:max-w-lg">
        <SheetHeader className="border-b px-6 py-4">
          ...
          <SheetDescription>
            Raise a limit without changing your plan. Add-ons work on every plan.
          </SheetDescription>
        </SheetHeader>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {opt.isUnlimited ? (
                          <span className="inline-flex items-center gap-1">
                            <InfinityIcon className="size-3" /> Unlimited on your
                            plan
                          </span>
                        ) : (
                          <>
                    ...
                    <>
                      ...
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <p className="text-right text-xs text-muted-foreground">
                          ...
                          {step} more for {inrShort(opt.pricePerStepMonthly ?? 0)} a
                          month
                          {pending > 0 && (
                        ...
                        <div className="rounded-lg bg-muted/50 p-3">
                          <div className="flex items-center justify-between gap-2 text-sm">
                            ...
                            <span className="font-semibold tabular-nums">
                              {opt.effective ?? 0} → {(opt.effective ?? 0) + pending * step}
                            </span>
                          </div>
                      ...
                      {pending > 0 && (
                        <p className="text-center text-xs text-muted-foreground">
                          Charged pro-rata for the days left in this period, then
                          it bills alongside your plan.
                        </p>
                      )}
