...
import bellOffIcon from "@iconify-icons/la/bell-slash";
...
import calendarIcon from "@iconify-icons/la/calendar-alt";
...
import fileExcelIcon from "@iconify-icons/la/file-excel";
import fileTextIcon from "@iconify-icons/la/file-alt";
import cloudUploadIcon from "@iconify-icons/la/cloud-upload-alt";
...
export const FileSpreadsheet = make(fileExcelIcon, "FileSpreadsheet");
